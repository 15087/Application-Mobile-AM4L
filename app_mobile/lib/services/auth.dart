...
class AuthService {
  final FirebaseAuth _auth = FirebaseAuth
      .instance; //'final' object qui ne changera pas, permettra de faire la co avec la db, underscore: propriété sera privée, utilisé que dans ce fichier
  ...
  Stream<User> get user {
    return _auth
        .onAuthStateChanged // on return onAuthh (stream) dans l'objet _auth
